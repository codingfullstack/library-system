...
$siteName = $_ENV['SEO_SITE_NAME'] ?? $_SERVER['SEO_SITE_NAME'] ?? 'Bibliotekų sistema';
...
return [
    ...
    'robots' => [
         ...
         * Default: false
         */
        'force_default' => $environment !== 'production',
    ],
     ...
     */
    'favicon' => file_exists(public_path('favicon.ico')) ? 'favicon.ico' : null,
    ...
    'description' => [
         ...
         */
        'fallback' => 'Bibliotekų sistema knygų paieškai, rezervacijoms ir viešų bibliotekų informacijai.',
    ],
    ...
    'image' => [
         ...
         */
        // TODO: pakeisti į reprezentacinį viešą sistemos paveikslėlį, kai toks asset bus paruoštas.
        'fallback' => file_exists(public_path('images/auth-illustration.png'))
    ...
    /*
     * Suderinamumo raktai esamai sitemap generavimo logikai.
     */
    'sitemap_path' => public_path('sitemap.xml'),
    'news_model' => null,
    'news_route' => 'news.show',
];
