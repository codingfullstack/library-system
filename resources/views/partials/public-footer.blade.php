<footer class="mx-auto flex w-full max-w-[1780px] flex-col gap-4 px-8 py-8 text-sm text-slate-500 md:flex-row md:items-center md:justify-between lg:px-12 xl:px-16 dark:text-zinc-400">
