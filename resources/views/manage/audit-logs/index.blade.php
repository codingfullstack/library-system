...
<x-layouts::app :title="'Audito žurnalas'">
    <x-ui.page class="max-w-none px-4 py-0 sm:px-6 lg:px-8">
        <div class="bg-[#f7f8fa] py-8 dark:bg-zinc-950">
            <div class="mx-auto max-w-[1500px] space-y-6">
                <div class="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                    <div>
                        <h1 class="text-4xl font-bold tracking-tight text-zinc-950 dark:text-white">Audito žurnalas</h1>
                        <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Peržiūrėkite svarbiausius sistemos veiksmus, jų objektus, šaltinius ir pakeitimus vienoje vietoje.</p>
                    </div>
                ...
                <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    <section class="rounded-[22px] border border-zinc-200/80 bg-white px-5 py-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <div class="text-sm font-medium text-zinc-500 dark:text-zinc-400">Visi įrašai</div>
                    ...
                    <section class="rounded-[22px] border border-zinc-200/80 bg-white px-5 py-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Kūrimo veiksmai</div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="rounded-[22px] border border-zinc-200/80 bg-white px-5 py-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <div class="text-sm font-medium text-zinc-500 dark:text-zinc-400">Pašalinta</div>
                                <div class="mt-1 text-3xl font-bold text-zinc-950 dark:text-white">{{ $summary['deleted'] }}</div>
                                <div class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Trinimai ir atšaukimai</div>
                            </div>
                        </div>
                    </section>
                </div>
                        ...
                        <form method="GET" action="{{ route('manage.audit-logs.index') }}" class="grid gap-3 xl:grid-cols-[minmax(320px,1.5fr)_220px_220px_180px_180px_auto_auto] xl:items-center">
                            <div class="relative xl:min-w-0">
                                <input
                                    ...
                                    placeholder="Ieškoti pagal aprašymą, darbuotoją, objektą, IP ar biblioteką..."
                                >
                ...
                <section class="overflow-hidden rounded-[24px] border border-zinc-200/80 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                    <div class="border-b border-zinc-200 px-5 py-4 dark:border-zinc-800">
                        <h2 class="text-lg font-semibold text-zinc-950 dark:text-white">Įrašai</h2>
                    ...
                    <div class="p-5">
                        @include('manage.audit-logs._list', [
                            ...
                            'emptyDescription' => 'Pagal dabartinius filtrus veiksmų istorijoje nieko neradome.',
                        ])
                    </div>
                    ...
                    @if ($auditLogs->isNotEmpty())
                        <div class="flex flex-col gap-4 border-t border-zinc-200 px-5 py-4 text-sm text-zinc-500 dark:border-zinc-800 dark:text-zinc-400 sm:flex-row sm:items-center sm:justify-between">
                            <div>Rodoma {{ $auditLogs->firstItem() }}-{{ $auditLogs->lastItem() }} iš {{ $auditLogs->total() }}</div>
