...
class KaltinenuLibraryDemoSeeder extends Seeder
{
    public function run(): void
    {
        DB::transaction(function () {
            ...
            $copies = collect([
                $this->createCopy($library, $hp1, $mainBranch, $fantasyLocation, 'KAL-HP1-001', 'QR-KAL-HP1-001', '9786090141601', BookCopy::STATUS_LOANED, BookCopy::CONDITION_GOOD, '2023-09-01', 'Dažnai skolinama knyga.'),
                ...
                $this->createCopy($library, $faultInOurStars, $childrenBranch, $childrenLocation, 'KAL-YA-002', 'QR-KAL-YA-002', '9786094799712', BookCopy::STATUS_AVAILABLE, BookCopy::CONDITION_GOOD, '2024-02-10', 'Laisva kopija, skirta greitam išdavimui rezervacijos eilėje.'),
                $this->createCopy($library, $book1984, $mainBranch, $classicLocation, 'KAL-1984-001', 'QR-KAL-1984-001', '9786090900491', BookCopy::STATUS_AVAILABLE, BookCopy::CONDITION_GOOD, '2023-01-15', null),
                $this->createCopy($library, $book1984, $mainBranch, $classicLocation, 'KAL-1984-002', 'QR-KAL-1984-002', '9786090900492', BookCopy::STATUS_AVAILABLE, BookCopy::CONDITION_GOOD, '2023-01-15', null),
                $this->createCopy($library, $hobbit, $mainBranch, $fantasyLocation, 'KAL-HOB-001', 'QR-KAL-HOB-001', '9786090158001', BookCopy::STATUS_AVAILABLE, BookCopy::CONDITION_GOOD, '2022-08-20', null),
                $this->createCopy($library, $hobbit, $mainBranch, $fantasyLocation, 'KAL-HOB-002', 'QR-KAL-HOB-002', '9786090158002', BookCopy::STATUS_AVAILABLE, BookCopy::CONDITION_WORN, '2022-08-20', null),
                $this->createCopy($library, $atomicHabits, $mainBranch, $classicLocation, 'KAL-AH-001', 'QR-KAL-AH-001', '9786090152681', BookCopy::STATUS_AVAILABLE, BookCopy::CONDITION_GOOD, '2024-06-10', null),
                $this->createCopy($library, $thinking, $mainBranch, $classicLocation, 'KAL-TF-001', 'QR-KAL-TF-001', '9785415020981', BookCopy::STATUS_AVAILABLE, BookCopy::CONDITION_GOOD, '2024-04-08', null),
                $this->createCopy($library, $littlePrince, $childrenBranch, $childrenLocation, 'KAL-MP-001', 'QR-KAL-MP-001', '9786090141561', BookCopy::STATUS_AVAILABLE, BookCopy::CONDITION_GOOD, '2023-11-09', null),
                $this->createCopy($library, $littlePrince, $childrenBranch, $childrenLocation, 'KAL-MP-002', 'QR-KAL-MP-002', '9786090141562', BookCopy::STATUS_AVAILABLE, BookCopy::CONDITION_WORN, '2023-11-09', null),
            ]);
            ...
            $this->recordHistory($copies[0], $staffA, null, BookCopy::STATUS_AVAILABLE, 'created', 'Kopija sukurta sistemoje.', CarbonImmutable::parse('2025-05-12 09:00:00'));
            $this->recordHistory($copies[0], $staffA, BookCopy::STATUS_AVAILABLE, BookCopy::STATUS_LOANED, 'issued', 'Kopija šiandien išduota skaitytojui.', $now->subHours(2));
            ...
            $this->recordHistory($copies[8], $staffA, null, BookCopy::STATUS_AVAILABLE, 'created', 'Kopija sukurta sistemoje.', CarbonImmutable::parse('2025-09-01 09:15:00'));
