...
it('shows books from all member libraries with library information', function () {
    ...
    $this->actingAs($member)
        ...
        ->assertSee(route('books.show', ['book' => $firstBook, 'library_id' => $firstLibrary->id]), false)
        ->assertSee(route('books.show', ['book' => $secondBook, 'library_id' => $secondLibrary->id]), false)
